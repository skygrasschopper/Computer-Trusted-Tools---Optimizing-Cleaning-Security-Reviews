...
echo                                                                                 RUN AS ADMIN!                                                                                      
echo Steps:                                                                                /\_/\
echo 1. Auto end tasks (#Caution! DON'T CLOSE TOOL HERE) 2. Network Flush 3. Disk Cleanup ((-v-))                   
...
start powershell.exe -Command "mode.com con: lines=19 cols=19; Start-Service -Name {NVDisplay.ContainerLocalSystem}"
start powershell.exe -Command "mode.com con: lines=19 cols=19; Start-Service -Name {NvContainerLocalSystem}"
::Start Service 2nd way (more reliable)
Title 1.2) Start Service (more reliable)
start powershell.exe -Command "mode.com con: lines=19 cols=19; Start-Service -DisplayName {NVIDIA Display Container LS}"
start powershell.exe -Command "mode.com con: lines=19 cols=19; Start-Service -DisplayName {NVIDIA LocalSystem Container}"
::Restart Apps
Title 1.3) Restart Apps
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\NVIDIA Corporation\NVIDIA GeForce Experience\NVIDIA GeForce Experience.exe"& exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\NVIDIA Corporation\NVIDIA GeForce Experience\GeForce Experience Permission.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\NVIDIA Corporation\NVIDIA GeForce Experience\NVIDIA Notification.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\NVIDIA Corporation\NVIDIA GeForce Experience\NVIDIA Share.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\NVIDIA Corporation\NvContainer\nvcontainer.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Windows\System32\DriverStore\FileRepository\nvlti.inf_amd64_af22935532babf10\Display.NvContainer\NVDisplay.Container.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files (x86)\NVIDIA Corporation\NvNode\NVIDIA Web Helper.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files (x86)\NVIDIA Corporation\NvNode\nvnodejslauncher.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "%userprofile%\AppData\Local\NVIDIA\NvBackend\ApplicationOntology\NvOAWrapperCache.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "%userprofile%\AppData\Local\NVIDIA\NvBackend\ApplicationOntology\OAWrapper.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\WindowsApps\NVIDIACorp.NVIDIAControlPanel_8.1.961.0_x64__56jybvy8sckqj\nvcplui.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\WindowsApps\NVIDIACorp.NVIDIAControlPanel_8.1.961.0_x64__56jybvy8sckqj\NvGpuUtilization.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\WindowsApps\NVIDIACorp.NVIDIAControlPanel_8.1.961.0_x64__56jybvy8sckqj\NvStereoUtilityOGL.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\WindowsApps\NVIDIACorp.NVIDIAControlPanel_8.1.961.0_x64__56jybvy8sckqj\NvStTest.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\WindowsApps\NVIDIACorp.NVIDIAControlPanel_8.1.961.0_x64__56jybvy8sckqj\NvStView.exe" & exit"
start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & "C:\Program Files\WindowsApps\NVIDIACorp.NVIDIAControlPanel_8.1.961.0_x64__56jybvy8sckqj\NvStWiz.exe" & exit"
...
echo    ======================================
    start cmd.exe @cmd /k "MODE CON: COLS=45 LINES=19 & color E0 & Title 3) Disk Cleanup & echo. & echo. & echo. & echo. &echo. &echo. & echo    ====================================== & echo    ==  Move your mouse in CIRCLE now!  == & echo    == This is to prevent getting stuck == & echo    ==        Click OK when DONE        == & echo    ====================================== & cleanmgr /verylowdisk & color 06 & exit"
color 0a
...
Title 12.2) San Graphic Quickboost (EVERYTHING IS NORMAL, CALM DOWN)
color 23
echo Big thanks to
echo.
echo   ********     **     ****     **     ********  *******       **     *******  **      ** **   ****** 
...
Title 12.4) Installer and Software Distribution Cleaner
color 9a
...
Title 12.6) Internet Explorer Cleaner
color de
...
Title 12.7) Discord Cache Cleaner
color 2f
...
Title 12.8) Current User Cleaner
...
TItle 12.9) Clean Overlapped Numbered Network Name
color 70
@echo off
set prefix=R.seau
set counter=0
...
Title 12.10) Clean Windows Update Cache
color 32
@ECHO OFF
NET STOP bits
NET STOP wuauserv
...
Title 12.11) Re-register DLL Files
color be
...
Title 12.12) Windows Log Cleaner
color a6
