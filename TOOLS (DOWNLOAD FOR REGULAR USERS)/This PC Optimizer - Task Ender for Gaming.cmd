::Intro
@echo off
Title "This PC" Optimizer - Task Ender for Gaming
MODE CON: COLS=90 LINES=50 & color 0c

echo RUN AS ADMIN! Run the "End Task part" only then repen NVIDIA GeForce Experience after ending all tasks.
echo.
echo Steps:
...
::Tasks that works only in the end
