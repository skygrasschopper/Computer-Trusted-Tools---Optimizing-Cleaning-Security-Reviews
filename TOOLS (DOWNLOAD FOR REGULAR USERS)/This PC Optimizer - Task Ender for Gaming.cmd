            ...
            Title 8a) Windows-Cache
                ...
                Title 8a.1) Win-Cache
                    ...
                    ::del /q/f/s "C:\Windows\ServiceProfiles\NetworkService\AppData\LocalLow\Microsoft\CryptnetUrlCache"
                        ...
                        start cmd.exe @cmd /k "Reset MStore Cache & MODE CON: COLS=20 LINES=20 & color 0a & wsreset & exit"
                ...
                del /q/f/s "C:\inetpub\history"
                    ...
                    del /q/f/s "%userprofile%\Local Settings\Temp\Cookies"
                        ::custom strong script to delete index.dat
                            ...
                            ::start cmd.exe @cmd /k "Title Delete index.dat & echo Index.dat are files hidden on your computer that contain all of the Web sites that you have ever visited... & MODE CON: COLS=50 LINES=50 & color 0b & cd C:\ & del index.dat /s & exit"
