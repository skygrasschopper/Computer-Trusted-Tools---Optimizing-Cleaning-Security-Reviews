...
Title 16.11) Removing Malware [MSRT] [Patience] [Require Name Check] [Attention]
    ...
    echo    /**        /**  ********  /**   //**    /**    
    echo    //         //  ////////   //     //     //  
    if EXIST "C:\Users\%username%\Downloads\Windows-KB890830-x64-V5.100.exe" (start /w "" "C:\Users\%username%\Downloads\Windows-KB890830-x64-V5.99.exe" /Q /F:Y & echo. & echo MSRT is scanning for running malware... & echo.) ELSE (echo MSRT not found, skipping... & echo.)
