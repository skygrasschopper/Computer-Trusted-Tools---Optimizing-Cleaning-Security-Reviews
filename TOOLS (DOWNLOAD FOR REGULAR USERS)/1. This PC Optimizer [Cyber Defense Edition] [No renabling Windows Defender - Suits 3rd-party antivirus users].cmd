@echo off
Title This PC Optimizer [Cyber Defense Edition] [No renabling Windows Defender - Suits 3rd-party antivirus users] {Hello %username%! Your lucky number on %DATE% is %random%, good luck!}
