...
Title 2.1) Fixing Windows Security [Blocking all connections]
...
Title 2.2.1) Fixing Windows Security [Registry attack fix] [Specific Malware Schedules]
    color 0b
...
Title 2.2.2) Fixing Windows Security [Registry attack fix] [Enable Firewall]
    color 0c
    reg add "HKLM\SYSTEM\CurrentControlSet\Services\mpssvc" /v Start /t REG_DWORD /d 2 /f    



Title 2.2.3) Fixing Windows Security [Registry attack fix] [Reset Connection Preference] [Network Customizers] [Caution]
    color 0d
...
Title 2.2.4) Fixing Windows Security [Registry attack fix] [Reset Certificates] [Certificate app downloaders] [Caution]
    color 0e
...
Title 2.2.5) Fixing Windows Security [Registry attack fix] [Security] [Security Policy adders] [Caution]
    color 01
...
Title 2.2.6) Fixing Windows Security [Register Group Policy and Registry changes]
    color 03
    gpupdate /force
...
Title 2.3.1) Fixing Windows Security [Services] [Stop Hacker Connection]
    color 06
    echo y|net stop RasMan
    echo y|net stop RasAuto
    echo y|net stop SessionEnv
...
Title 2.3.2) Fixing Windows Security [Services] [Stop Spying]
    color 09
    net stop WbioSrvc
    net stop FrameServer
    net stop FrameServerMonitor
...
Title 2.3.3) Fixing Windows Security [Services] [Remove Malware Service]
    color 0b
...
Title 2.4) Fixing Windows Security [REMOVE MALWARE] [Custom list]
    color 04
...
Title 2.5.1) Fixing Windows Security [Resetting network connection]
    echo    ********************************
...
Title 2.5.2) Fixing Windows Security [Resetting network connection] [Reconnect to Wifi]
    color 0e
    netsh int ip reset resettcpip.txt
    netsh winhttp reset proxy
    netsh int ip reset
...
Title 9.9.11) Custom Scripts [Windows Log Cleaner] {Sorry random guy...}
color 36
...
Title 14.1.1) Preparing Defender Scan [Registry attack fix] [Specific Malware Schedules]
    color 06
    REM Add specific Malware Registry below to remove
    reg delete "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tree\System" /f
    reg delete "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\System32" /f      
...
Title 14.1.2) Preparing Defender Scan [Registry attack fix] [Enable Firewall]
    color 09
    reg add "HKLM\SYSTEM\CurrentControlSet\Services\mpssvc" /v Start /t REG_DWORD /d 2 /f    



Title 14.1.3) Preparing Defender Scan [Registry attack fix] [Reset Connection Preference] [Network Customizers] [Caution]
    color 0b
    reg delete "HKCU\Network" /f
    reg add "HKCU\Network" /f
    reg delete "HKCU\Software\Microsoft\Remote Assistance" /f
...
Title 14.1.4) Preparing Defender Scan [Registry attack fix] [Reset Certificates] [Certificate app downloaders] [Caution]
    color 0d
    reg delete "HKCU\Software\Microsoft\SystemCertificates\AuthRoot" /f
    reg add "HKCU\Software\Microsoft\SystemCertificates\AuthRoot\Certificates" /f
    reg add "HKCU\Software\Microsoft\SystemCertificates\AuthRoot\CRLs" /f
...
Title 14.2.1) Preparing Defender Scan [Registry attack fix] [Security] [Security Policy adders] [Caution]
    color 0e
    reg delete "HKLM\SECURITY" /f
    reg add "HKLM\SECURITY" /f
...
Title 14.2.2) Preparing Defender Scan [Register Group Policy and Registry changes]
    color 01
    gpupdate /force
...
Title 14.3.1) Preparing Defender Scan [Services] [Stop Hacker Connection]
    color 09
    net stop RasMan
    net stop RasAuto
    net stop SessionEnv
...
Title 14.3.2) Preparing Defender Scan [Services] [Stop Spying]
    color 0b
    net stop WbioSrvc
    net stop FrameServer
    net stop FrameServerMonitor
...
Title 14.3.3) Preparing Defender Scan [Services] [Remove Malware Service]
    color 0d
    REM Custom Malware Services Below to remove
    net stop Service
    sc delete Service
...
Title 14.4) Preparing Defender Scan [REMOVE MALWARE] [Custom list]
    color 05
    REM Custom Malware Path below to remove
    del /q/f/s "C:\Users\%username%\AppData\Roaming\414.exe"
    del /q/f/s "C:\Users\%username%\AppData\Roaming\12.exe"
...
Title 14.5) Preparing Defender Scan [Signature Update]
    color 09
...
Title 17.1) War is Over [Uninstall] [McAfee Stinger] {Will fail}
::Uninstall McAfee
    color 50
