...
MODE CON: COLS=19 LINES=19
    start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & color 03 & Title 1.35) Power (Auto-generate) & powercfg -energy & move "C:\WINDOWS\system32\energy-report.html" "C:\File and Network Reports - DELETABLE" & color 06 & exit"        
color 06
...
MODE CON: COLS=19 LINES=19
        ...
        Title 1.36.1) Resource View (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & color 03 & Title 1.36.1) Resource View (Autorun) & perfmon /res & color 06 & exit"
        ::1.36.2) System Diagnostics Data Report (Autorun) 
        Title 1.36.2) System Diagnostics Data Report (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & color 03 & Title 1.36.2) System Diagnostics Data Report (Autorun) & perfmon /report & color 06 & exit"
        ::1.36.3) Reliability Monitor Report (Autorun)
        Title 1.36.3) Reliability Monitor Report (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & color 03 & Title 1.36.3) Reliability Monitor Report (Autorun) & perfmon /rel & color 06 & exit"
        ::1.36.4) Performance Monitor View (Autorun)
        Title 1.36.4) Performance Monitor View (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=19 LINES=19 & color 03 & Title 1.36.4) Performance Monitor View (Autorun) & perfmon /sys & color 06 & exit"
