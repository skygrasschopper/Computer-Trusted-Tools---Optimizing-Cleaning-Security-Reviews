...
echo 35. Power                                  /      ' o'\   
echo 36. Performance Monitor Reports         ,-;  '.  :   _c           
echo 37. Delete generated files             :_."\._ ) ::-"                 
echo                                               ""m "m   
date /t
echo Version 3.0
echo Made for
...
MODE CON: COLS=20 LINES=20
    ...
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1) Auto generate Parent Report Folder & mkdir "C:\File and Network Reports - DELETABLE" & color 06 & exit"
color 06
::1.1) Wifi Report (Auto-generate)
color 06
Title 1.1) Wi-Fi Report (Auto-generate)
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.1) Wi-Fi Report (Auto-generate) & netsh wlan show wlanreport & move "C:\ProgramData\Microsoft\Windows\WlanReport\wlan-report-latest.html" "C:\File and Network Reports - DELETABLE" & color 06 & exit"        
color 0D
...
MODE CON COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title God Mode (Auto-generate) & cd "C:\File and Network Reports - DELETABLE" & mkdir GodMode.{ED7BA470-8E54-465E-825C-99712043E01C} & exit"
color 0D
...
MODE CON: COLS=20 LINES=20
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.2.1) Winsock send autotuning information (Auto-generate) & netsh winsock show autotuning > "C:\File and Network Reports - DELETABLE\2.1) Winsock send autotuning information.txt" & color 06 & exit"
    color 03
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.2.2) Network devices and entries (Auto-generate) & netsh winsock show catalog > "C:\File and Network Reports - DELETABLE\2.2) Network devices and entries.txt" & color 06 & exit"
    color 05
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.3) Saved Wi-Fi and other Wi-Fi hardware Info... (Auto-generate) & netsh wlan show all > "C:\File and Network Reports - DELETABLE\3) Saved Wi-Fi and other Wi-Fi hardware Info.txt" & color 06 & exit"
color 09
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.4) Saved Wi-Fi only (Auto-generate) & netsh wlan show profiles > "C:\File and Network Reports - DELETABLE\4) Saved Wi-Fi only.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.5) Certificates (Auto-generate) & certutil -store -silent My & certutil -store -silent -user > "C:\File and Network Reports - DELETABLE\5) Certificates.txt" & color 06 & exit"
color 06
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.6) MAC Address (Auto-generate) & getmac > "C:\File and Network Reports - DELETABLE\6) MAC Address.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.7) IP routing table (Auto-generate) & route print > "C:\File and Network Reports - DELETABLE\7) IP routing table.txt" & color 06 & exit"
color 06
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.8) Local accounts (Auto-generate) & net accounts > "C:\File and Network Reports - DELETABLE\8) Local accounts.txt" & color 06 & exit"
color 05
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.9) Server Information (Auto-generate) & net config > "C:\File and Network Reports - DELETABLE\9) Server Information.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.10) Shared files on servers (Auto-generate) & net file > "C:\File and Network Reports - DELETABLE\10) Shared files on servers.txt" & color 06 & exit"
color 09
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.11) Computer groups (Auto-generate) & net localgroup > "C:\File and Network Reports - DELETABLE\11) Computer groups.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.12) Net session (Auto-generate) & net session > "C:\File and Network Reports - DELETABLE\12) Net session.txt" & color 06 & exit"
color 05
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.13) Running Network services (Auto-generate) & net start > "C:\File and Network Reports - DELETABLE\13) Running Network services.txt" & color 06 & exit"
color 09
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.14) Shared resources on network (Auto-generate) & net use > "C:\File and Network Reports - DELETABLE\14) Shared resources on network.txt" & color 06 & exit"
color 05
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.15) Users on this PC (Auto-generate) & net user > "C:\File and Network Reports - DELETABLE\15) Users on this PC.txt" & color 06 & exit"
color 06
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.16) Entries in Address Resolution Protocal cache (Auto-generate) & arp -a > "C:\File and Network Reports - DELETABLE\16) Entries in Address Resolution Protocal cache.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.17) IP configuration values (Auto-generate) & ipconfig /all > "C:\File and Network Reports - DELETABLE\17) IP configuration values.txt" & color 06 & exit"
color 09
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.18) DNS (Auto-generate) & ipconfig /displaydns > "C:\File and Network Reports - DELETABLE\18) DNS.txt" & color 06 & exit"
color 06
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.19) Remote machine cache (Auto-generate) & nbtstat -c > "C:\File and Network Reports - DELETABLE\19) Remote machine cache.txt" & color 06 & exit"
color 04
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.20) Local NetBIOs names (Auto-generate) & nbtstat -n > "C:\File and Network Reports - DELETABLE\20) Local NetBIOs names.txt" & color 06 & exit"
color 05
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.21) Name resolved (Auto-generate) & nbtstat -r > "C:\File and Network Reports - DELETABLE\21) Name resolved.txt" & color 06 & exit"
color 06
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.22) Sessions table with destination IP (Auto-generate) & nbtstat -S > "C:\File and Network Reports - DELETABLE\22) Sessions table with destination IP.txt" & color 06 & exit"
color 09
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.23) Session table converting destination IP (Auto-generate) & nbtstat -s > "C:\File and Network Reports - DELETABLE\23) Sessions table converting destination IP.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.24) Ethernet statics (Auto-generate) & netstat -e > "C:\File and Network Reports - DELETABLE\24) Ethernet statics.txt" & color 06 & exit"
color 06
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.25) Connection statics (Auto-generate) & netstat -s > "C:\File and Network Reports - DELETABLE\25) Connection statics.txt" & color 06 & exit"
color 09
::1.26) Connections and listening ports (Auto-generate)
color 09
Title 1.26) Connections and listening ports (Auto-generate)
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.26) Connections and listening ports (Auto-generate) & netstat -a > "C:\File and Network Reports - DELETABLE\26) Connections and listening ports.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.27) Connections and listening ports with PID (Auto-generate) & netstat -o > "C:\File and Network Reports - DELETABLE\27) Connections and listening ports with PID.txt" & color 06 & exit"
color 06
...
MODE CON: COLS=20 LINES=20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.28) Systeminfo (Auto-generate) & systeminfo > "C:\File and Network Reports - DELETABLE\28) Systeminfo.txt" & color 06 & exit"
color 03
...
MODE CON: COLS=20 LINES=20
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.29.1) Running tasks ONLY (Auto-generate) & tasklist > "C:\File and Network Reports - DELETABLE\29.1) Running tasks ONLY.txt" & color 06 & exit"
    color 09
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.29.2) Running tasks and info (Auto-generate) & tasklist /v  > "C:\File and Network Reports - DELETABLE\29.2) Running tasks and info.txt" & color 06 & exit"
    color 06
    ...
    MODE CON: COLS=20 Lines=20
        start powershell.exe -Command "Get-service | Out-File -FilePath {C:\File and Network Reports - DELETABLE\29.3 Running tasks Stopped or Running.txt}"
    color 06
...
MODE CON: COLS=20 LINES=20
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.30.1.1) File tree ONLY C-drive (Auto-generate) & tree C:  > "C:\File and Network Reports - DELETABLE\30.1.1) File tree ONLY C-drive.txt" & color 06 & exit"
    color 03
...
MODE CON: COLS=20 LINES=20
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.30.2.1) File tree EXPANDED C-drive (Auto-generate) & tree C: /f  > "C:\File and Network Reports - DELETABLE\30.2.1) File tree EXPANDED C-drive.txt" & color 06 & exit"
    color 06
...
MODE CON: COLS=20 LINES=20
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.31.1.1) File list SHORT C-drive (Auto-generate) & dir C: > "C:\File and Network Reports - DELETABLE\31.1.1) File list SHORT C-drive.txt" & color 06 & exit"
    color 03
...
MODE CON: COLS=20 LINES 20
    ...
    MODE CON: COLS=20 LINES=20
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.31.2.1) File list LONG C-drive (Auto-generate) & dir C: /n /q > "C:\File and Network Reports - DELETABLE\31.2.1) File list LONG C-drive.txt" & color 06 & exit"
    color 06
...
MODE CON: COLS=20 LINES 20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.32) Windows Packages (Auto-generate) & DISM /online /get-packages > "C:\File and Network Reports - DELETABLE\32) Windows Packages.txt" & color 06 & exit"
color 09
...
MODE CON: COLS=20 LINES 20
    Title 1.33.1) Apps-Windows10 (Auto-generate)
        start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.33.1) Apps-Windows10 (Auto-generate) & wmic product get name,version > "C:\File and Network Reports - DELETABLE\33.1) Apps-Windows10.txt" & color 06 & exit"
    Title 1.33.2) Apps-Windows11 (Auto-generate)
        start powershell.exe -Command "Get-AppxPackage -AllUsers | Out-File -FilePath {C:\File and Network Reports - DELETABLE\33.2 Apps-Windows11.txt}"
...
MODE CON: COLS=20 LINES 20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.34) Policy info for user and Computer (Auto-generate) & gpresult /z > "C:\File and Network Reports - DELETABLE\34) Policy info for user and Computer.txt" & color 06 & exit"

::1.35) Power (Auto-generate)
color 03
Title 1.35) Power (Auto-generate)
MODE CON: COLS=20 LINES 20
    start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.35) Power (Auto-generate) & powercfg -energy & move "C:\WINDOWS\system32\energy-report.html" "C:\File and Network Reports - DELETABLE" & color 06 & exit"        
color 06
...
MODE CON: COLS=20 LINES 20
        ...
        Title 1.36.1) Resource View (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.36.1) Resource View (Autorun) & perfmon /res & color 06 & exit"
        ::1.36.2) System Diagnostics Data Report (Autorun) 
        Title 1.36.2) System Diagnostics Data Report (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.36.2) System Diagnostics Data Report (Autorun) & perfmon /report & color 06 & exit"
        ::1.36.3) Reliability Monitor Report (Autorun)
        Title 1.36.3) Reliability Monitor Report (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.36.3) Reliability Monitor Report (Autorun) & perfmon /rel & color 06 & exit"
        ::1.36.4) Performance Monitor View (Autorun)
        Title 1.36.4) Performance Monitor View (Autorun)
            start cmd.exe @cmd /k "MODE CON: COLS=20 LINES=20 & color 03 & Title 1.36.4) Performance Monitor View (Autorun) & perfmon /sys & color 06 & exit"
